...
import * as StyledLinkStories from './StyledLink.stories'

<Meta of={StyledLinkStories} />

# StyledLink Component
  
This is the text describing the `StyledLink` component. It is written in MDX so you can use
...
```jsx
<Canvas of={StyledLinkStories.Default} />

<Canvas of={StyledLinkStories.Bar} />
```
